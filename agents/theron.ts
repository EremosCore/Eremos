...
export const Theron: Agent = {
  ...
  description:
    "The first observer. Theron archives anomalies but does not emit. All agent heuristics fragment from him - he stores the primordial memory stack. He is, the core.",
